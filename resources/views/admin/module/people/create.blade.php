    ...
    <form class="form-horizontal" action="{{ route('admin.people.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control" id="name" type="text" name="name" placeholder="Name" value="{{ old('name') }}"/>
                        @if($errors->has('name'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control" id="designation" type="text" name="designation" placeholder="Designation" value="{{ old('designation') }}"/>
